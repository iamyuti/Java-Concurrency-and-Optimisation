...
/**
 * Eine Beobachtung einer Honigbiene.<p>
 *
 * Invarianten: Erbt alle Invarianten von SocialBee. Das sind:<br>
 ...
 *   von Beobachtungen (außer bei remove())<br>
 * - Außerdem sind Honigbienen immer sozial.<p>
 *
 * History Constraints: Erbt alle History Constraints von SocialBee. Dies sind:<br>
 * Server-kontrolliert:
 ...
 * - Subtyp von SocialBee, da Honigbienen immer sozial (staatenbildend) leben.<br>
 * - Kein Subtyp von WildBee oder eine ihrer Subklassen, da explizit angegeben wird,
 * dass Honigbienen keine Wildbienen sind und außerdem nie solitär oder kommunal leben.<br>
...
public class Honeybee implements SocialBee {
    ...
    /**
     * Konstruktor für eine Observation einer Honigbiene
     * Vorbedingung:
     ...
     */
    public Honeybee(ObservationList observations, LocalDateTime dateTime, String comment) {
        this(observations, dateTime, comment, null,null);
    }

    /**
     * Konstruktor für eine Observation einer Honigbiene mit Chip-Zahl
     * Vorbedingung:
     * <li>observations, dateTime und comment dürfen nicht null sein</li>
     * Nachbedingungen:
     * <li>Das Objekt ist initialisiert./li>
     ...
     */
    public Honeybee(ObservationList observations, LocalDateTime dateTime, String comment, Integer chip) {
     ...
     */
    public Honeybee(ObservationList observations, LocalDateTime dateTime, String comment, Bee previousBee) {
     ...
     */
    public Honeybee(ObservationList observations, LocalDateTime dateTime, String comment, Integer chip, Bee previousBee) {
    ...
    public String toString() {
        return """
               HONEYBEE
                     Eine Beobachtung einer Honigbiene.
                     Staatenbildend, ausgeprägtes Sozialverhalten
                     Solitär oder kommunal lebende Honigbienen gibt es nicht
                     Alle vorkommenden Honigbienen als Nutztiere gezüchtet
              """;
    }
