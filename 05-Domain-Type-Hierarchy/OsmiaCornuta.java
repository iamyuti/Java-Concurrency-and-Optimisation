...
/**
 * Eine Beobachtung einer gehörnten Mauerbiene.
 * Das ist eine solitär lebende Wildbiene.
 * Obwohl unter günstigen Bedingungen viele Weibchen dicht beieinander nisten können,
 * sucht jedes Weibchen eine eigene Nisthöhle.<p>
 *
 * Invariante: Erbt alle Invarianten von SolitaryBee. Das sind:<br>
 ...
 * - Subtyp von SolidaryBee, da dies explizit eine solitär lebende Biene ist.<br>
...
public class OsmiaCornuta implements SolitaryBee {
    ...
    /**
     * Marker, ob die beobachtete gehörnte Mauerbiene aus einer Zucht stammt
     */
    ...
    /**
     * Gibt zurück, ob die beobachtete Osmia Cornuta aus Zucht stammt
     * Nachbedingung:
     * - Gibt true zurück, wenn Osmia Cornuta aus einer Zucht stammt
     * - Gibt false zurück, wenn Osmia Cornuta aus keiner Zucht stammt.
    ...
    /**
     * Konstruktor für eine Observation einer gehörnten Mauerbiene
     * und Angabe, ob die gehörnte Mauerbiene aus einer Zucht kommt
     ...
     * @param zucht Ob die gehörnte Mauerbiene aus einer Zucht kommt (null, wenn keine Angabe)
     */
    public OsmiaCornuta(ObservationList observations, LocalDateTime dateTime, String comment, Boolean zucht) {
        this(observations, dateTime, comment, null,null, zucht);
    }

    /**
     * Konstruktor für eine Observation einer gehörnten Mauerbiene
     * mit Chip-Zahl und Angabe, ob die gehörnte Mauerbiene aus einer Zucht kommt.
     * sowie, ob aus dieser Beobachtung eine eindeutig solitäre Lebensweise hervorgeht
     * Vorbedingung:
     * <li>observations, dateTime und comment dürfen nicht null sein</li>
     * Nachbedingungen:
     ...
     * @param zucht Ob die gehörnte Mauerbiene aus einer Zucht kommt (null, wenn keine Angabe)
     */
    public OsmiaCornuta(ObservationList observations, LocalDateTime dateTime, String comment, Integer chip, Boolean zucht) {
     ...
     * @param zucht Ob die gehörnte Mauerbiene aus einer Zucht kommt (null, wenn keine Angabe)
     */
    public OsmiaCornuta(ObservationList observations, LocalDateTime dateTime, String comment, Bee previousBee, Boolean zucht) {
     ...
     * @param previousBee Vorangegangene Observation des gleichen Individuums
     * @param zucht Ob die gehörnte Mauerbiene aus einer Zucht kommt (null, wenn keine Angabe)
     * @throws IllegalArgumentException Falls Zeitstempel oder Kommentar null sind
     */
    public OsmiaCornuta(ObservationList observations, LocalDateTime dateTime, String comment, Integer chip, Bee previousBee, Boolean zucht) {
    ...
    public String toString() {
        return """
               OSMIA CORNUTA
                       Eine Beobachtung einer gehörnten Mauerbiene.
                       Das ist eine solitär lebende Wildbiene.                                                                                     \s
              """;
    }
