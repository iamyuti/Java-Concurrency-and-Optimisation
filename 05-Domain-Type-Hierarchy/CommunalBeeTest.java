 ...
 */
public class CommunalBeeTest implements CommunalBee {
    ...
    /**
     * Marker, ob die beobachtete kommunale Biene aus einer Zucht stammt
     */
     ...
     * Nachbedingung:
     * - true, wenn die Beobachtung auf eine eindeutig kommunale Lebensweise hinweist.
    ...
    /**
     * Konstruktor für eine Observation einer kommunalen Biene (zur Testung)
     * Vorbedingung: Alle Argumente nicht null
     * und Angabe, ob die kommunale Biene aus einer Zucht kommt
     ...
     * @param zucht Ob die kommunale Biene aus einer Zucht kommt (null, wenn keine Angabe)
     ...
     */
    public CommunalBeeTest(ObservationList observations, LocalDateTime dateTime, String comment, Boolean zucht,
            boolean solitary, boolean communal) {
        this(observations, dateTime, comment, null,null, solitary, zucht, communal);
    }

    /**
     * Konstruktor für eine Observation einer kommunalen Biene (zur Testung)
     * mit Chip-Zahl und Angabe, ob die kommunale Biene aus einer Zucht kommt.
     * sowie, ob aus dieser Beobachtung eine eindeutig solitäre oder kommunale Lebensweise hervorgeht.
     * Vorbedingung: Alle Argumente nicht null
     * Nachbedingung: Das Objekt ist initialisiert
     * @param observations Liste aller Observationen (System) in dem die Beobachtung registriert wird
     ...
     * @param communal Ob aus dieser Beobachtung eindeutig eine kommunale Lebensweise hervorgeht
     */
    public CommunalBeeTest(ObservationList observations, LocalDateTime dateTime, String comment, Integer chip, Boolean zucht,
            boolean solitary, boolean communal) {
        this(observations, dateTime, comment, chip,null, solitary, zucht, communal);
    }
     ...
     * @param communal Ob aus dieser Beobachtung eindeutig eine kommunale Lebensweise hervorgeht
     */
    public CommunalBeeTest(ObservationList observations, LocalDateTime dateTime, String comment, Bee previousBee, Boolean zucht,
            boolean solitary, boolean communal) {
        this(observations, dateTime, comment, null, previousBee, solitary, zucht, communal);
    }
     ...
     * und Angabe, ob die kommunale Biene aus einer Zucht kommt.
     * Vorbedingungen:
     * <li>Liste aller Observationen, Zeitstempel & Kommentar nicht null, Zucht null, wenn keine Angabe bekannt.</li>
     ...
     * @param communal Ob aus dieser Beobachtung eindeutig eine kommunale Lebensweise hervorgeht
     */
    public CommunalBeeTest(ObservationList observations, LocalDateTime dateTime, String comment, Integer chip, Bee previousBee, Boolean zucht,
            boolean solitary, boolean communal) {
    ...
    public String toString() {
        return """
               COMMUNAL BEE
                    Eine Beobachtung einer Biene einer kommunalen Art.
                    Kommunale Bienen leben in Nestern, die sich mehrere ausgewachsene Bienen teilen.
                    Alle kommunalen Bienen können auch alleine, also solitär leben.
                    KANN eine Biene kommunal leben (auch wenn sie es nicht tut), gilt sie als kommunal.                                                                                      \s
              """;
    }
     ...
     * @param to Ende des Zeitraums
     * @return Iterator über alle Beobachtungen des gleichen Individuums im Zeitraum [from, to]
     * @throws IllegalArgumentException falls {@code from > to}, from oder to null, Liste aller Observationen null
     */
        ...
        return new Iterator<>() {
            ...
            private void findNext() {
                ...
                while (base.hasNext()) {
                    ...
                    if (!(b instanceof CommunalBeeTest cb)) continue;
             ...
             * Nachbedingung: Gibt nächste Beobachtung dieses Individuums zurück, aus der kommunale Lebensweise hervorgeht.
             * @return Nächste Beobachtung, aus der kommunale Lebensweise hervorgeht.
