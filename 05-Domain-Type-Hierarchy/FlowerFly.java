...
/**
 * Eine Beobachtung einer Schwebfliege.<p>
 *
 * Invarianten: Erbt alle Invarianten von Pollinator. Das sind:<br>
 ...
 *
 * History Constraints: Erbt alle History Constraints von Pollinator. Dies sind:<br>
 * Server-kontrolliert:
 ...
 * - Subtyp von Pollinator.<br>
 * - Kein Subtyp von Wasp oder Bee, da nicht mit Wespen oder Bienen verwandt.
...
public class FlowerFly implements Pollinator{
    ...
    /**
     * Referenz zur Liste aller Beobachtungen im System
     */
    ...
    /**
     * Konstruktor für eine Schwebfliege
     ...
     * @throws IllegalArgumentException Falls ein Parameter null ist
     */
    public FlowerFly(ObservationList observations, LocalDateTime dateTime, String comment) {
    ...
    public String toString() {
        return """
               FLOWERFLY
                    Eine Beobachtung einer Schwebfliege.
                    Schwebfliegen gehören zu den Fliegen und sind daher nicht mit Bienen und Wespen verwandt.
                    Sie sind Bestäuber von Blütenpflanzen.
              """;
    }
